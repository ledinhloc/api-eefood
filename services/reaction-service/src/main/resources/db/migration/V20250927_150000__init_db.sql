...
(
    ...
    CONSTRAINT pk_comment_images PRIMARY KEY (comment_id, image_url),
...
(
    ...
    CONSTRAINT pk_comment_videos PRIMARY KEY (comment_id, video_url),
    CONSTRAINT fk_comment_videos_comment FOREIGN KEY (comment_id)
        REFERENCES comment (id) ON DELETE CASCADE
);
...
ALTER TABLE post
    ADD COLUMN approved_by VARCHAR DEFAULT 'AI';