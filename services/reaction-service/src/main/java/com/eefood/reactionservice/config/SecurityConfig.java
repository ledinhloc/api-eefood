    ...
    httpSecurity.authorizeHttpRequests(
        request ->
            request.requestMatchers(PUBLIC_ENDPOINTS).permitAll()
              ...
              .requestMatchers(HttpMethod.GET, "/api/v1/livestreams/active").permitAll()
              .requestMatchers(HttpMethod.GET, "/api/v1/payment/vnpay/**").permitAll()
              .requestMatchers(HttpMethod.POST, "/api/v1/livestreams/subtitles/transcripts").permitAll()
