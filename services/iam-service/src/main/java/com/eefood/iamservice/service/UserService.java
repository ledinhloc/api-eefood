...
import com.eefood.iamservice.producer.FirebaseNotificationProducer;
...
public class UserService {
  ...
  public UserResponse login(String email, String password, String fcmToken) {
    ...
    UserNotificationResponse fcmRequest = UserNotificationResponse.builder()
            .id(userResponse.getId())
            .email(userResponse.getEmail())
            .username(userResponse.getUsername())
            .fcmToken(fcmToken)
            .build();
    firebaseNotificationProducer.sendEmailProducerEvent(fcmRequest);
    return userResponse;
  }
