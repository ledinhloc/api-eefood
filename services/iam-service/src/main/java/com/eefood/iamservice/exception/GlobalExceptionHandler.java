package com.eefood.iamservice.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ResponseData<Void>> handleResponseStatusException(ResponseStatusException ex) {
    ...
    public ResponseData<Void> handleUniqueConstraintViolation(DataIntegrityViolationException ex) {
        ...
        return new ResponseData<>(HttpStatus.BAD_REQUEST.value(),
                ErrorMessage.CONSTRAINT_VIOLATION.getMessage() + message);
    }
    ...
    public ResponseData<Void> jsonParseErrorHandler(HttpMessageNotReadableException ex) {
        return new ResponseData<>(HttpStatus.BAD_REQUEST.value(),
                ErrorMessage.MALFORMED_JSON.getMessage() + ex.getMessage());
    }
    ...
    public ResponseData<Void> handleAuthorizationDeniedException(AuthorizationDeniedException ex) {
        return new ResponseData<>(HttpStatus.FORBIDDEN.value(),
                ErrorMessage.ACCESS_DENIED.getMessage());
    }

    @ExceptionHandler(HttpRequestMethodNotSupportedException.class)
    @ResponseStatus(HttpStatus.BAD_REQUEST)
    public ResponseData<Void> handleHttpRequestMethodNotSupportedException(HttpRequestMethodNotSupportedException ex) {
