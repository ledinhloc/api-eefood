...
public class AuthService {
    ...
    private void handleKeycloakCreationResponse(ResponseEntity<?> creationResponse,
                                                User savedUser,
                                                UserSignUpRequest request) {
        if (creationResponse == null) {
            throw new RuntimeException("Keycloak createUser response is null for email=" + request.getEmail());
        }
        ...
        if (status == HttpStatus.CREATED) {
            ...
            if (authId != null) {
                ...
                log.warn("Keycloak returned CREATED but Location header missing for email={}", request.getEmail());
            }
            ...
            throw new RuntimeException("Failed to create user in Keycloak. status=" + status + " for email=" + request.getEmail());
        }
    }
